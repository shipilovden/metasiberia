...
declare class SubscriptionHandleImpl<DBView = any, Reducers = any, SetReducerFlags = any> {
    ...
    private db;
    private onError?;
    constructor(db: DbConnectionImpl<DBView, Reducers, SetReducerFlags>, querySql: string[], onApplied?: (ctx: SubscriptionEventContextInterface<DBView, Reducers, SetReducerFlags>) => void, onError?: ((ctx: ErrorContextInterface<DBView, Reducers, SetReducerFlags>, error: Error) => void) | undefined);
    /**
