...
var SubscriptionHandleImpl = (_a11 = class {
  ...
  unsubscribe() {
    ...
    this.db["unsubscribe"](__privateGet(this, _queryId));
  }
  /**
...
handleOnOpen_fn2 = function() {
  ...
  switch (message.tag) {
    ...
    case "SubscribeApplied": {
      ...
      const { event: _, ...subscriptionEventContext } = eventContext;
      const callbacks = __privateMethod(this, _DbConnectionImpl32_instances, applyTableUpdates_fn).call(this, message.tableUpdates, eventContext);
      (_b = __privateGet(this, _subscriptionManager).subscriptions.get(message.queryId)) == null ? void 0 : _b.emitter.emit("applied", subscriptionEventContext);
      for (const callback of callbacks) {
        callback.cb();
      }
      break;
    ...
    case "UnsubscribeApplied": {
      ...
      const { event: _, ...subscriptionEventContext } = eventContext;
      const callbacks = __privateMethod(this, _DbConnectionImpl32_instances, applyTableUpdates_fn).call(this, message.tableUpdates, eventContext);
      (_c = __privateGet(this, _subscriptionManager).subscriptions.get(message.queryId)) == null ? void 0 : _c.emitter.emit("end", subscriptionEventContext);
      for (const callback of callbacks) {
        callback.cb();
      }
      break;
    ...
    case "SubscriptionError": {
      ...
      if (message.queryId) {
        (_d = __privateGet(this, _subscriptionManager).subscriptions.get(message.queryId)) == null ? void 0 : _d.emitter.emit("error", errorContext, error);
      } else {
